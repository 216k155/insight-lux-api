...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.luxd.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    islsr20Transfer: transaction.islsr20Transfer,
  };
...
TxController.prototype.transformLuxTransaction = function(transaction) {
